...
//./bin/finch-opt --loop-invariant-code-motion --finch-instantiate --finch-looplet-sequence --finch-looplet-run --finch-simplifier --finch-looplet-stepper --finch-looplet-sequence --finch-looplet-run --finch-simplifier --finch-instantiate --finch-looplet-run  --sparsifier ../test9.mlir
